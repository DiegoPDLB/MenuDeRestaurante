...
La orden de comida es un codigo que se divide en el main, producto, alimentos, bebidas, extras y venta.
...
int main(){
	...
	venta menug; //Aquí se empieza con la creacion del menú
		...
		//Aquí preparo los extras que corresponden a la tercera sección
